...
\begin{equation}\label{eq:diff}
 \bm{J}_{diff,k} = - \mathcal{D}_k\nabla c_k
\end{equation}
Where  $\bm{J}_{diff,k}$ is the particle flux of ion species $k$, $\mathcal{D}_k$ is the diffusion coefficient and $c_k$ is the concentration.
